                    ...
                    <div class="first-sidemenu">
                        <div class="line-animations">
                            <ul class="resp-tabs-list hor_1">
                                 ...
                                 <li class="resp-tab-active active"><a href="https://oneid10.github.io/Home-Dashboard"><span class="side-menu__icon"></span><img src="https://1dapp.github.io/Home-Dashboard/Content/assets/img/homepage.png" class="side_menu_img svg-1" alt="image" data-toggle="tooltip"  data-original-title="Home"></a></li>
    ...
    var events = myContractInstance.getPastEvents('getMoneyForLevelEvent', { filter: { _user: account }, 'fromBlock': 0, 'toBlock': 'latest'}, function (error, log) {
        ...
        if (!error) {
            $.each(log, function (key, value) {
                ...
                $('.totalreferral').html(Math.round(500000 * (referraltotal)) / 500000);
            });
    ...
    var events = myContractInstance.getPastEvents('getPoolPayment', {filter : { _receiver: account },  'fromBlock': 0, 'toBlock': 'latest'}, function (error, log) {
        ...
        if (!error) {
            $.each(log, function (key, value) {
                ...
                $('.totalpoolpayment').html(Math.round(500000 * (referraltotal)) / 500000);
            });
        }
    });
...
$(document).ready(function () {
    $('.pool1pay').click(function (demo) {
        ...
        try {
            ...
            ethereum.enable();
            myContractInstance1.methods.buyPool1().send({ from: account, value: 1000000000000000000, gas: 250000 })
    ...
    $('.pool2pay').click(function () {
        try {
            ...
            myContractInstance1.methods.buyPool2().send({ from: account, value: 2000000000000000000, gas: 250000 })
                .on('transactionHash', function (hash) {
    ...
    $('.pool3pay').click(function () {
        try {
            ...
            myContractInstance1.methods.buyPool3().send({ from: account, value: 5000000000000000000, gas: 250000 })
                .on('transactionHash', function (hash) {
    ...
    $('.pool4pay').click(function () {
        try {
            ...
            myContractInstance1.methods.buyPool4().send({ from: account, value: 10000000000000000000, gas: 250000 })
                .on('transactionHash', function (hash) {
    ...
    $('.pool5pay').click(function () {
        try {
            ...
            myContractInstance1.methods.buyPool5().send({ from: account, value: 20000000000000000000, gas: 250000 })
                .on('transactionHash', function (hash) {
    ...
    $('.pool6pay').click(function () {
        try {
            ...
            myContractInstance1.methods.buyPool6().send({ from: account, value: 50000000000000000000, gas: 250000 })
                .on('transactionHash', function (hash) {
    ...
    $('.pool7pay').click(function () {
        try {
            ...
            myContractInstance1.methods.buyPool7().send({ from: account, value: 100000000000000000000, gas: 250000 })
                .on('transactionHash', function (hash) {
    ...
    $('.pool8pay').click(function () {
        try {
            ...
            myContractInstance1.methods.buyPool8().send({ from: account, value: 200000000000000000000, gas: 250000 })
                .on('transactionHash', function (hash) {
    ...
    $('.pool9pay').click(function () {
        try {
            ...
            myContractInstance1.methods.buyPool9().send({ from: account, value: 500000000000000000000, gas: 250000 })
                .on('transactionHash', function (hash) {
    ...
    $('.pool10pay').click(function () {
        try {
            ...
            myContractInstance1.methods.buyPool10().send({ from: account, value: 1000000000000000000000, gas: 250000 })
                .on('transactionHash', function (hash) {
        ...
        <div class="row ">
            <div class="col-md-3 col-xs-6">
                <div class="card text-center overflow-hidden">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mb-5">Globally <strong>2</strong> people pays <br /> <strong>1</strong> ETH each</p>
            ...
            <div class="col-md-3 col-lg-3  col-xs-6">
                <div class="card text-center overflow-hidden">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mb-5">Globally <strong>4</strong> people pays  <br /><strong>5</strong> ETH each</p>
                        <p class="mb-5">No Referral necessary</p>
            ...
            <div class="col-md-3 col-lg-3  col-xs-6">
                <div class="card text-center overflow-hidden">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mb-5">Globally <strong>5</strong> people pays  <br /><strong>10</strong> ETH each</p>
                        <p class="mb-5">No Referral necessary</p>
            ...
            <div class="col-md-3 col-lg-3  col-xs-6">
                <div class="card text-center overflow-hidden">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mb-5">Globally <strong>6</strong> people pays  <br /><strong>20</strong> ETH each</p>
                        <p class="mb-5">No Referral necessary</p>
            ...
            <div class="col-md-3 col-lg-3  col-xs-6">
                <div class="card text-center overflow-hidden">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mb-5">Globally <strong>7</strong> people pays  <br /><strong>50</strong> ETH each</p>
                        <p class="mb-5">No Referral necessary</p>
            ...
            <div class="col-md-3 col-lg-3  col-xs-6">
                <div class="card text-center overflow-hidden">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mb-5">Globally <strong>8</strong> people pays  <br /><strong>100</strong> ETH each</p>
                        <p class="mb-5">No Referral necessary</p>
            ...
            <div class="col-md-3 col-lg-3  col-xs-6">
                <div class="card text-center overflow-hidden">
                    ...
                    <div class="card-body">
                        <h1 class="pricing-card-title mb-5">200 ETH</h1>
                        <p class="mb-5">Globally <strong>9</strong> people pays  <br /><strong>200</strong> ETH each</p>
                        <p class="mb-5">No Referral necessary</p>
            ...
            <div class="offset-lg-3 col-md-3 col-lg-3  col-xs-6">
                <div class="card text-center overflow-hidden">
                    ...
                    <div class="card-body">
                        <h1 class="pricing-card-title mb-5">500 ETH</h1>
                        <p class="mb-5">Globally <strong>10</strong> people pays  <br /><strong>500</strong> ETH each</p>
                        <p class="mb-5">No Referral necessary</p>
            ...
            <div class="col-md-3 col-lg-3  col-xs-6">
                <div class="card text-center overflow-hidden">
                    ...
                    <div class="card-body">
                        <h1 class="pricing-card-title mb-5">1000 ETH</h1>
                        <p class="mb-5">Globally <strong>300</strong> people pays  <br /><strong>1000</strong> ETH each</p>
                        <p class="mb-5">No Referral necessary</p>
